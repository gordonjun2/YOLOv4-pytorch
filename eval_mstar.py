...
class Evaluation(object):
    def __init__(
        ...
        self.__num_class = cfg.MSTAR_DATA["NUM"]
        ...
        self.__mode = mode
        self.__classes = cfg.MSTAR_DATA["CLASSES"]
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--visiual",
        type=str,
        default="MSTAR_detection/VOCdevkit2007/VOC2007/JPEGImages",
    ...
    logger = Logger(
        log_file_name=opt.log_val_path + "/log_mstar_val.txt",
